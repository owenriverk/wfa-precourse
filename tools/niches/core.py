...
{'cat': 'Rescue & Public Safety',
 ...
 'h2_days': 'Missions are made of these',
 'h2_path': 'Before the interview, read these',
 'path_intro': 'Teams run on a shared assessment language. This order gets you conversational fastest:',
 'faq_title': 'Asked at every tryout',
 'faq': [('Do I need a WFR before I can join a SAR team?',
          'Usually not to apply — most teams take promising candidates and train them up, though '
          'mission-qualified status typically requires a WFR or EMT card from a recognized provider. '
          'Every team writes its own rules, so ask yours. What you can do before the interview is show '
...
{'cat': 'Motorized & Airborne',
 ...
 'h2_days': 'Three ways a ride goes down',
 'h2_path': 'Five lessons before the next loop',
 'path_intro': 'The full course is fifteen lessons; these five earn a place in your top box first:',
 'faq_title': 'Asked at the gas stop',
 'faq': [('Should you take a downed rider’s helmet off?',
...
{'cat': 'Rural & Homesteading',
 ...
 'h2_days': 'The mornings that go sideways',
 'h2_path': 'Five lessons before opening day',
 'path_intro': 'In the order your seasons serve them up:',
 'faq_title': 'Asked at the tailgate',
 'faq': [('Is a tourniquet overkill for a hunting pack?',
         ...
         ('What does a heart attack look like in the field?',
          ...
          'exertion stops, he sits down, he chews an aspirin if nothing forbids it, and help starts '
          'moving now. Denial is part of the presentation — plan for it.')],
 'slug': 'hunters',
...
{'cat': 'Trail & Mountain',
 ...
 'h2_days': 'Miles-from-the-car problems',
 'h2_path': 'Read these five first',
 'path_intro': 'This order pays off soonest once the trailhead is behind you:',
 'faq_title': 'Asked around the bear hang',
...
{'cat': 'Trail & Mountain',
 ...
 'h2_days': 'How rides end early',
 'h2_path': 'Front-load these five',
 'path_intro': 'Ordered by what actually ends ride days:',
 'faq_title': 'Parking-lot questions',
 'faq': [('Broken or sprained — can you tell on the trail?',
          'Usually not, and it doesn’t change much: if it might be broken, treat it like it’s broken. '
          'Splint it padded and snug, check the fingers before and after (wiggle, feel, warm), and let '
          'an X-ray settle the argument in town.'),
         ('When does a crashed rider stay off the bike?',
          'Any head hit with confusion, any neck pain with a real mechanism, and any rider whose story '
          'keeps changing. “I’m fine” from a guy who just flew fifteen feet is a data point, not a '
          'diagnosis — take his pulse twice, ten minutes apart, and believe the trend.'),
...
{'cat': 'Trail & Mountain',
 ...
 'h2_days': 'When a run stops being a run',
 'h2_path': 'Five lessons for people who travel light',
 'path_intro': 'This order front-loads what running trails serve up:',
 'faq_title': 'Mid-run questions',
 'faq': [('What can you actually do with race-vest supplies?',
          'More than you’d think. The two highest-yield moves on a running trail need no '
          'equipment at all: opening an airway with positioning, and cooling an overheated brain with '
          'water and shade. Your spare layer is a pressure dressing; your gels treat a sugar crash. The gap is '
          'knowledge, not gear.'),
         ('Heat exhaustion or heat stroke — where’s the line?',
          'The brain. Cramps, nausea, and misery with a working mind is heat exhaustion — rest, shade, '
          'fluids. The moment your partner stops making sense it’s heat stroke, and the treatment is '
          'aggressive cooling right where they are. The walk-to-the-car decision is the one that '
          'kills.'),
...
{'cat': 'Youth & Education',
 ...
 'h2_days': 'On your watch',
 'h2_path': 'The leader’s study order',
 'path_intro': 'Front-loaded for what youth groups actually produce:',
 'faq_title': 'Asked at leader meetings',
 'faq': [('Does this satisfy my organization’s training requirement?',
          'Almost certainly not, and we won’t pretend otherwise. Councils, schools, and camps name their '
          'approved providers, and a free online course isn’t one — check your handbook. What this does '
          'is make the required weekend easier and the years between renewals safer.'),
         ('What emergencies actually find youth groups?',
          'The ones that arrive with the kids: allergies, asthma, diabetes. Medical histories travel '
          'into the woods, so know every camper’s conditions before the trailhead, know exactly which '
          'pack holds the epinephrine, and make “where’s the epi?” a question with a five-second '
          'answer.'),
         ('How do I run an emergency and a group at the same time?',
          'By delegating like it’s your job, because it is. One buddy pair fetches the med kit, a '
          'co-leader walks everyone else to a snack spot, and nobody goes anywhere alone, ever. '
